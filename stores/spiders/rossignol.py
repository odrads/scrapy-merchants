...
class SnowboardRossignolSpider(scrapy.Spider):
    name = "rossignol"
    allowed_domains = ['clevelandgolf.com']
    ...
    def start_requests(self):
        ...
        with open('./USPostalCode.txt', 'r') as f:
            ...
            for row in reader:
                ...
                latitude = row[9]
                longitude = row[10]
                url = "http://www.clevelandgolf.com/on/demandware.store/Sites-Cleveland-Site/default/Stores-GetDealers?lat=%s&lng=%s&countryCode=US&postalCode=%s&mileRadius=99999&dService=&cProduct=" % (latitude, longitude, postal_code)
